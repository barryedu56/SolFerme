    ...
    try {
      ...
      return {
        summary: {
          ...
          // Cumulés (identiques ici, le calcul local est déjà "tout l'historique")
          total_revenues: totalRevenues?.cnt || 0,
          total_encaissements: totalEncaissements?.cnt || 0,
          total_creances: (totalRevenues?.cnt || 0) - (totalEncaissements?.cnt || 0),
          total_expenses: totalExpensesAmount,
          total_profit: (totalRevenues?.cnt || 0) - totalExpensesAmount,
          total_lot_investment: lotPurchasesCost?.cnt || 0,
          total_feed_cost: feedPurchasesCost?.cnt || 0,
          total_health_cost: healthPurchasesCost?.cnt || 0,
          total_payroll_cost: payrollCost?.cnt || 0,
          total_other_expenses: totalStandaloneExpenses?.cnt || 0,
